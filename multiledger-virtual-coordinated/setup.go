...
// setupSwapClient builds a SwapClient for the coordinated virtual-channel PoC.
//
//   - coordinator is Charlie's on-chain address; it is wired into every parent
//     ledger channel's params so the adjudicator accepts the coordinator's
