module perun-multiledger-poc/multiledger-virtual-coordinated
...
require (
	cross-chain-coordinator v0.0.0-20260526064411-ffeb034d4626
	github.com/ethereum/go-ethereum v1.17.2
	github.com/libp2p/go-libp2p v0.48.0
	github.com/perun-network/perun-eth-backend v0.6.0
	perun-multiledger-poc/multiledger-channel v0.0.0
...
replace cross-chain-coordinator => github.com/NhoxxKienn/cross-chain-coordinator v0.0.0-20260526064411-ffeb034d4626

replace perun-multiledger-poc/multiledger-channel => ../multiledger-channel
