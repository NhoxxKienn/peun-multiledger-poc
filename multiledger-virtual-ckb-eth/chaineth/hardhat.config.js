// Chain A for the optimistic multi-ledger virtual-channel PoC.
//
// 500 ms auto-mine interval (matches multiledger-defended/) so the dispute
// path completes quickly. Four pre-funded accounts: deployer, Alice, Bob, Hub.
// Hub is the intermediary that holds parent channels with both Alice and Bob;
// see ../README.md for the topology.
export default {
  solidity: "0.8.28",
  networks: {
    hardhat: {
