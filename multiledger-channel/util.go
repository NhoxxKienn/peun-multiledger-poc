...
func setupPaymentClient(
	...
	coordinatorNotifier *p2p.RelayCoordinatorNotifier,
) *client.SwapClient {
	...
	c, err := client.SetupSwapClient(
		...
		waddress,
		coordinatorNotifier,
		common.Address{}, // honest demo: no coordinator
		false,            // honest demo: keep strict proposal/update validation
		true,             // honest demo: auto-watch the channel
	)
	if err != nil {
		panic(err)
	}
